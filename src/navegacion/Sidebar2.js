...
const SlideBar2 = () => {
    ...
    return (
        <div className='slidebar1'>
            <ul>
                <li>
                    <NavLink to="/perfilDonador"  className='text-light rounded py-3 my-3 w-100 d-inline-block px-3 text-center' style={{ 'fontSize': '20px', 'height':'50px' }}  activeclassname='active'><SlEnvolopeLetter className='me-2' color="white" />Perfil</NavLink>
                </li>
                <li>
                    <NavLink to="/comunidad" className='text-light rounded py-2 my-3  w-100 d-inline-block px-3 text-center'style={{ 'fontSize': '20px', 'height':'50px' }} activeclassname='active'><FaUsers className='me-2' color="white" />Publicaciones</NavLink>
                </li>
                {/* <li>
